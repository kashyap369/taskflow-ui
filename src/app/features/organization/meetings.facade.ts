...
import { MeetingAccessLevel, MeetingDetail, MeetingListItem, MeetingParticipantState, MeetingPayload } from './meetings.models';
...
export class MeetingsFacade {
  ...
  clear(): void { this.organizationId = null; this._meetings.set([]); this._detail.set(null); this._listLoading.set(false); this._detailLoading.set(false); this._saving.set(false); this._listError.set(false); this._detailError.set(false); }
